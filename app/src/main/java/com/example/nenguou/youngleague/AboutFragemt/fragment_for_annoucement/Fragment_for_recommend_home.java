...
public class Fragment_for_recommend_home extends BaseFragent {
    ...
    public void initView() {
        ...
        newsList.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                Log.i("ccount", "countt");
                new LoadMoreDataAsyncTask(Fragment_for_recommend_home.this, count).execute();
                count++;
            }
        });
    ...
    class FirstLoadDataAsyncTask extends AsyncTask<Integer, Void, List<newsModel>>{
        ...
        private int count = 0;
        private Fragment_for_recommend_home fragment111;
        private String contennt;
        List<newsModel> manyNews;

        public FirstLoadDataAsyncTask(Fragment_for_recommend_home fragment111) {
    ...
    class LoadMoreDataAsyncTask extends AsyncTask<Integer, Void, List<newsModel>> {
        ...
        //构造方法
        public LoadMoreDataAsyncTask(Fragment_for_recommend_home fragment111, int count) {
            this.count = count;
            this.fragment111 = fragment111;
        }
    ...
    private void initId() {
        newsList = (PullToRefreshListView) view.findViewById(R.id.newsList);
    }

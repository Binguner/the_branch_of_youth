...
public class Fragment_for_journal_dangke extends BaseFragent {
    ...
    private PullToRefreshListView newsList_for_journal_dangke;
    @Override
    ...
    public void initView() {
        ...
        newsList_for_journal_dangke.setAdapter(journal_adapter);
        new FirstLoadDataAsyncTask(Fragment_for_journal_dangke.this).execute();
        newsList_for_journal_dangke.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
            ...
            new LoadMoreDataAsyncTask(Fragment_for_journal_dangke.this,count);
            count++;
            }
        });
        newsList_for_journal_dangke.setMode(PullToRefreshBase.Mode.BOTH);
    }

    class FirstLoadDataAsyncTask extends AsyncTask<Integer, Void, List<Journal_Model>> {

        private int count = 0;
        private Fragment_for_journal_dangke fragment111;
        private String contennt;
        List<Journal_Model> manyNews;

        public FirstLoadDataAsyncTask(Fragment_for_journal_dangke fragment111) {
        ...
        protected List<Journal_Model> doInBackground(Integer... integers) {
            ...
            Request request = new Request
                    ...
                    .url("http://47.92.28.251:1024/journal/0/4/list?user_id=9965029")
                    .build();
...
//                    Log.i("fucknii", manyNews.get(1).createdAt.toString());
                ...
                fragment111.newsList_for_journal_dangke.onRefreshComplete();
    ...
    class LoadMoreDataAsyncTask extends AsyncTask<Integer, Void, List<Journal_Model>> {
        ...
        //构造方法
        public LoadMoreDataAsyncTask(Fragment_for_journal_dangke fragment111, int count) {
            this.count = count;
            this.fragment111 = fragment111;
        }
        ...
        protected List<Journal_Model> doInBackground(Integer... integers) {
            ...
            Request request = new Request
                    ...
                    .url("http://47.92.28.251:1024/journal/"+count+"/4/list?user_id=9965029")
                    .build();
            Response respones = null;
            try {
                respones = client.newCall(request).execute();
    ...
    private void initId() {
        newsList_for_journal_dangke = (PullToRefreshListView) view.findViewById(R.id.newsList_for_journal_dangke);
    }

...
public class Fragment_for_journal_all extends BaseFragent {
    ...
    public void initView() {
        ...
        newsList_for_journal_all.setAdapter(journal_adapter);
        new FirstLoadDataAsyncTask(Fragment_for_journal_all.this).execute();
        newsList_for_journal_all.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                new LoadMoreDataAsyncTask(Fragment_for_journal_all.this, count).execute();
                count++;
            }
        });
        newsList_for_journal_all.setMode(PullToRefreshBase.Mode.BOTH);
    }

    class FirstLoadDataAsyncTask extends AsyncTask<Integer, Void, List<Journal_Model>> {

        private int count = 0;
        private Fragment_for_journal_all fragment111;
        private String contennt;
        List<Journal_Model> manyNews;

        public FirstLoadDataAsyncTask(Fragment_for_journal_all fragment111) {
        ...
        protected void onPostExecute(List<Journal_Model> journal_models) {
            ...
            if (fragment111.manyNews.isEmpty()) {
                ...
                fragment111.newsList_for_journal_all.onRefreshComplete();
    ...
    class LoadMoreDataAsyncTask extends AsyncTask<Integer, Void, List<Journal_Model>> {
        ...
        //构造方法
        public LoadMoreDataAsyncTask(Fragment_for_journal_all fragment111, int count) {
            this.count = count;
            this.fragment111 = fragment111;
        }

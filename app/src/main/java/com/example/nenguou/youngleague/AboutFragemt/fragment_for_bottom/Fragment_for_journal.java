...
public class Fragment_for_journal extends BaseFragent {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        startEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               Intent intent = new Intent(getContext(),aty_journal_addjournal.class);
                startActivity(intent);
               // over
               // ActivityOptionsCompat activityOptionsCompat = ActivityOptionsCompat.makeCustomAnimation(getContext(),R.anim.slide_from_right,R.anim.slide_to_right);
          //      ActivityCompat.startActivity(getContext(),new Intent(getContext(),aty_journal_addjournal.class),activityOptionsCompat.toBundle());
    ...
    public void initView() {
        ...
        startEdit = (ImageButton) view.findViewById(R.id.startEdit);
    }

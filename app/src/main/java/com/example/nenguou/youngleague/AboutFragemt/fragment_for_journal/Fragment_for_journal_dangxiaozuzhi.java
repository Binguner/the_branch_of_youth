...
public class Fragment_for_journal_dangxiaozuzhi extends BaseFragent {
    ...
    private PullToRefreshListView newsList_for_journal_dangxiaozuhui;
    @Override
    ...
    public void initView() {
        ...
        newsList_for_journal_dangxiaozuhui.setAdapter(journal_adapter);
        new FirstLoadDataAsyncTask(Fragment_for_journal_dangxiaozuzhi.this).execute();
        newsList_for_journal_dangxiaozuhui.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                new LoadMoreDataAsyncTask(Fragment_for_journal_dangxiaozuzhi.this,count).execute();
            }
        });
        newsList_for_journal_dangxiaozuhui.setMode(PullToRefreshBase.Mode.BOTH);
    }
    ...
    class FirstLoadDataAsyncTask extends AsyncTask<Integer, Void, List<Journal_Model>> {
        ...
        private int count = 0;
        private Fragment_for_journal_dangxiaozuzhi fragment111;
        private String contennt;
        List<Journal_Model> manyNews;

        public FirstLoadDataAsyncTask(Fragment_for_journal_dangxiaozuzhi fragment111) {
        ...
        protected List<Journal_Model> doInBackground(Integer... integers) {
            ...
            Request request = new Request
                    ...
                    .url("http://47.92.28.251:1024/journal/0/3/list?user_id=9965029")
                    .build();
        ...
        protected void onPostExecute(List<Journal_Model> journal_models) {
            ...
            if (fragment111.manyNews.isEmpty()) {
                ...
                fragment111.newsList_for_journal_dangxiaozuhui.onRefreshComplete();
    ...
    class LoadMoreDataAsyncTask extends AsyncTask<Integer, Void, List<Journal_Model>> {
        ...
        //构造方法
        public LoadMoreDataAsyncTask(Fragment_for_journal_dangxiaozuzhi fragment111, int count) {
            this.count = count;
            this.fragment111 = fragment111;
        }
        ...
        protected List<Journal_Model> doInBackground(Integer... integers) {
            ...
            Request request = new Request
                    ...
                    .url("http://47.92.28.251:1024/journal/"+count+"/3/list?user_id=9965029")
                    .build();
            Response respones = null;
            try {
                respones = client.newCall(request).execute();
    ...
    private void initId() {
        newsList_for_journal_dangxiaozuhui = (PullToRefreshListView) view.findViewById(R.id.newsList_for_journal_dangxiaozuhui);
    }

...
public class Fragment_for_recommend_teachershow extends BaseFragent {
    ...
    public void initView() {
        ...
        new FirstLoadDataAsyncTask(Fragment_for_recommend_teachershow.this).execute();
        // item 点击事件
        ...
        newsList.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                ...
                Log.i("ccount", "countt");
                new LoadMoreDataAsyncTask(Fragment_for_recommend_teachershow.this, count).execute();
                count++;
            }
        });
    ...
    class FirstLoadDataAsyncTask extends AsyncTask<Integer, Void, List<newsModel>> {
        ...
        private int count = 0;
        private Fragment_for_recommend_teachershow fragment111;
        private String contennt;
        List<newsModel> manyNews;

        public FirstLoadDataAsyncTask(Fragment_for_recommend_teachershow fragment111) {
        ...
        protected List<newsModel> doInBackground(Integer... integers) {
            ...
            Request request = new Request
                    ...
                    .url("http://47.92.28.251:1024/article/" + count + "/2/list")
                    .build();
    ...
    class LoadMoreDataAsyncTask extends AsyncTask<Integer, Void, List<newsModel>> {
        ...
        //构造方法
        public LoadMoreDataAsyncTask(Fragment_for_recommend_teachershow fragment111, int count) {
            this.count = count;
            this.fragment111 = fragment111;
        }
    ...
    private void initId() {
        newsList = (PullToRefreshListView) view.findViewById(R.id.newsListforteachershow);
    }

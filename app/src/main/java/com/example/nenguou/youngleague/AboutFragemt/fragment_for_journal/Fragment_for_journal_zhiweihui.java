...
public class Fragment_for_journal_zhiweihui extends BaseFragent {
    ...
    private PullToRefreshListView newsList_for_journal_zhiweihui;
    @Override
    ...
    public void initView() {
        ...
        newsList_for_journal_zhiweihui.setAdapter(journal_adapter);
        new FirstLoadDataAsyncTask(Fragment_for_journal_zhiweihui.this).execute();
        newsList_for_journal_zhiweihui.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
            ...
            public void onPullUpToRefresh(PullToRefreshBase<ListView> refreshView) {
                new LoadMoreDataAsyncTask(Fragment_for_journal_zhiweihui.this, count).execute();
                count++;
            }
        });
        newsList_for_journal_zhiweihui.setMode(PullToRefreshBase.Mode.BOTH);
    }
    ...
    class FirstLoadDataAsyncTask extends AsyncTask<Integer, Void, List<Journal_Model>> {
        ...
        private int count = 0;
        private Fragment_for_journal_zhiweihui fragment111;
        private String contennt;
        List<Journal_Model> manyNews;

        public FirstLoadDataAsyncTask(Fragment_for_journal_zhiweihui fragment111) {
        ...
        protected List<Journal_Model> doInBackground(Integer... integers) {
            ...
            Request request = new Request
                    ...
                    .url("http://47.92.28.251:1024/journal/0/2/list?user_id=9965029")
                    .build();
        ...
        protected void onPostExecute(List<Journal_Model> journal_models) {
            ...
            if (fragment111.manyNews.isEmpty()) {
                ...
                fragment111.newsList_for_journal_zhiweihui.onRefreshComplete();
    ...
    class LoadMoreDataAsyncTask extends AsyncTask<Integer, Void, List<Journal_Model>> {
        ...
        //构造方法
        public LoadMoreDataAsyncTask(Fragment_for_journal_zhiweihui fragment111, int count) {
            this.count = count;
            this.fragment111 = fragment111;
        }
        ...
        protected List<Journal_Model> doInBackground(Integer... integers) {
            ...
            Request request = new Request
                    ...
                    .url("http://47.92.28.251:1024/journal/"+count+"/2/list?user_id=9965029")
                    .build();
            Response respones = null;
            try {
                respones = client.newCall(request).execute();
    ...
    private void initId() {
        newsList_for_journal_zhiweihui = (PullToRefreshListView) view.findViewById(R.id.newsList_for_journal_zhiweihui);
    }
